...
void UiEditorAppStyler::timerCallback()
{
    if( _app_instance_store->editor_config.current_editable_colour ) {
        if( target_color != _app_instance_store->editor_config.current_editable_colour )
        {
            ...
            colour_selector->setCurrentColour( Colour( *_app_instance_store->editor_config.current_editable_colour ) );
        }
    }
    else
    {
        _app_instance_store->editor_config.current_editable_colour = &_app_instance_store->color_theme->elem_color_1;
	target_color = _app_instance_store->editor_config.current_editable_colour;
	colour_selector->setCurrentColour( Colour( *_app_instance_store->editor_config.current_editable_colour ) );
	//last_col_refresh = *target_color;
	//col_1->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_1) );
    }

    if( last_col_refresh != colour_selector->getCurrentColour().getARGB() || *target_color != last_col_refresh )
    {
        ...
        _app_instance_store->editor->lock.enter();
        {
            ...
            {
                GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR = colour_selector->getCurrentColour().getARGB();
                repaint();
            }

            {
                ...
                col_1->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_1) );
                col_3->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_3) );
                col_4->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_4) );
                col_5->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_5) );
                col_6->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_6) );
                col_7->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_7) );
                col_8->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_8) );
                col_9->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_9) );
                col_10->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->elem_color_10) );
                col_11->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->main_border) );
                col_12->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->main_bg) );
                col_13->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->bar_area_border) );
                col_14->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->bar_area_bg) );
                col_15->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->step_area_border) );
                col_16->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->step_area_bg) );
                col_17->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->main_step_bg) );
                col_18->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->bar_step_bg) );
                col_19->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->step_step_bg) );
                col_2->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->main_step_border) );
                col_20->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->bar_step_border) );
                col_21->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->step_step_border) );
                col_22->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->slider_knob_color) );
                col_23->setColour( TextButton::buttonColourId, Colour(_app_instance_store->color_theme->slider_outline) );
                col_master->setColour( TextButton::buttonColourId, Colour(GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR) );

                if( ! label_current_color->isBeingEdited() )
                    label_current_color->setText( String(colour_selector->getCurrentColour().toString()), dontSendNotification );

                if( ! list->isBeingEdited() )
                    list->setText(
                        _app_instance_store->color_theme->get_color_list(),
    ...
    : UiEditor("B-Styler"),_app_instance_store(app_instance_store_)
{
    ...
    addAndMakeVisible (label_current_color = new Label (String(),
            String()));
    ...
    addAndMakeVisible (list = new Label (String(),
                                         String()));
    ...
    list->setColour (Label::outlineColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
...
void UiEditorAppStyler::resized()
{
    ...
    toolbar->setBounds (getWidth() - proportionOfWidth (0.0847f), 0, proportionOfWidth (0.0847f), proportionOfHeight (0.4167f));
    colour_selector->setBounds (proportionOfWidth (0.0170f), proportionOfHeight (0.0208f), proportionOfWidth (0.4407f), proportionOfHeight (0.6250f));
    col_1->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.0417f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_3->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.1042f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_4->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.1667f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_5->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.2292f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_6->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.2917f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_7->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.3542f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_8->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.4167f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_9->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.4792f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_10->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.5417f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_11->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.1042f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_12->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.0417f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_13->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.3542f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_14->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.2917f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_15->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.6042f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_16->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.5417f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    label_current_color->setBounds (proportionOfWidth (0.0339f), proportionOfHeight (0.6500f), proportionOfWidth (0.4068f), proportionOfHeight (0.0500f));
    copy->setBounds (proportionOfWidth (0.0339f), proportionOfHeight (0.7917f), proportionOfWidth (0.1186f), proportionOfHeight (0.0521f));
    past->setBounds (proportionOfWidth (0.1695f), proportionOfHeight (0.7917f), proportionOfWidth (0.1186f), proportionOfHeight (0.0521f));
    col_17->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.1667f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_18->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.4167f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_19->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.6667f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    rand->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.8958f), proportionOfWidth (0.1017f), proportionOfHeight (0.0625f));
    list->setBounds (proportionOfWidth (0.0339f), proportionOfHeight (0.7083f), proportionOfWidth (0.4068f), proportionOfHeight (0.0667f));
    col_2->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.2292f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_20->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.4792f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_21->setBounds (proportionOfWidth (0.6949f), proportionOfHeight (0.7292f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_22->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.6667f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    col_23->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.7292f), proportionOfWidth (0.2034f), proportionOfHeight (0.0417f));
    style_1->setBounds (proportionOfWidth (0.0339f), proportionOfHeight (0.8958f), proportionOfWidth (0.0678f), proportionOfHeight (0.0625f));
    style_3->setBounds (proportionOfWidth (0.2034f), proportionOfHeight (0.8958f), proportionOfWidth (0.0678f), proportionOfHeight (0.0625f));
    style_4->setBounds (proportionOfWidth (0.3729f), proportionOfHeight (0.8958f), proportionOfWidth (0.0678f), proportionOfHeight (0.0625f));
    style_5->setBounds (proportionOfWidth (0.2881f), proportionOfHeight (0.8958f), proportionOfWidth (0.0678f), proportionOfHeight (0.0625f));
    button_info->setBounds (proportionOfWidth (0.9271f), proportionOfHeight (0.4375f), proportionOfWidth (0.0509f), proportionOfHeight (0.0625f));
    col_master->setBounds (proportionOfWidth (0.4746f), proportionOfHeight (0.7917f), proportionOfWidth (0.4237f), proportionOfHeight (0.0417f));
    reset->setBounds (proportionOfWidth (0.3220f), proportionOfHeight (0.7917f), proportionOfWidth (0.1186f), proportionOfHeight (0.0521f));
    rand2->setBounds (proportionOfWidth (0.6271f), proportionOfHeight (0.8958f), proportionOfWidth (0.2712f), proportionOfHeight (0.0625f));
    style_6->setBounds (proportionOfWidth (0.1186f), proportionOfHeight (0.8958f), proportionOfWidth (0.0678f), proportionOfHeight (0.0625f));
...
void UiEditorAppStyler::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == rand)
    {
        ...
        while( some_colours_left )
        {
            ...
            *_app_instance_store->color_theme->color_list.getUnchecked(i) = Colour( col, col, rand.nextFloat(), 1.f ).getARGB();
    ...
    else if (buttonThatWasClicked == style_1)
    {
        ...
        _app_instance_store->color_theme->set_theme("ff4a4a4a,ff0079ad,ff000000,ff7c7eab,ff624739,ff5f7183,ff494b62,ff8a8a8a,ff4c7086,ffababab,ff080d0f,ffb1b1b1,ff100f12,ff767676,ff070707,ff0e2149,ff171717,ff100f15,ff565963,ff171717,ff000000,ff000411,ff2c2c2c,ffdfce89,ffdfce89,");
    ...
    else if (buttonThatWasClicked == style_3)
    {
        ...
        _app_instance_store->color_theme->set_theme("ffb62439,ffb62439,ff161616,fff66b02,ff53f468,ff06b1bb,ff06b1bb,ff06b1bb,ff06b1bb,ff161616,ff2b2b2b,ff161616,ff202020,ff161616,ff393939,ff2b2b2b,ff393939,ff202020,ff191919,ff161616,ff161616,ff161616,ff161616,fff68606,fff68606,");
    ...
    else if (buttonThatWasClicked == style_4)
    {
        ...
        _app_instance_store->color_theme->set_theme("ffae1a1c,ffae1a1c,ff161616,ffdfce89,ffff8b00,ffededed,ffededed,ffededed,ffededed,ff858585,ff393a38,ff736e6e,ff262525,ff737373,ff525252,ff333333,ff515151,ff262525,ff191919,ff303030,ff0f0e0e,ff1a1a1a,ff141414,ffededed,ffededed,");
    ...
    else if (buttonThatWasClicked == style_5)
    {
        ...
        _app_instance_store->color_theme->set_theme("ffd2253f,ffd2253f,ff161616,ffc59a6f,ffe4790e,ffc59a6f,ffc59a6f,ffc59a6f,ffc59a6f,ffb9ab72,ff333333,ffb9ab72,ff545454,ffb9ab72,ff282828,ff333333,ff333333,ff333333,ff191919,ff191919,ff191919,ff000000,ff141414,ffdfce89,ffdfce89,");
    ...
    else if (buttonThatWasClicked == reset)
    {
        ...
        _app_instance_store->color_theme->set_theme("ffd0222d,ffd0222d,ff140e0a,ffc9a376,fff98120,ffff7f2b,ff86983d,ff4dadb1,ffdfce89,ff94895b,ff2e2017,ffdfce89,ff412d21,ffb9ab72,ff281c14,ff2a1e16,ff281c14,ff38281d,ff191919,ff191919,ff191919,ff000000,ff141414,ffdfce89,ffdfce89,");
    ...
    else if (buttonThatWasClicked == style_6)
    {
        ...
        _app_instance_store->color_theme->set_theme("ff6d2724,fff19a53,ff321914,fffb8829,ffe0b789,ffe0b789,fff19a53,fff19a53,fff19a53,fff19a53,ff2d2321,ff231e1c,ff52433e,ff1f1918,ff3f3430,ff2d2321,ff3f3430,ff52433e,ff201917,ff2b2422,ff392e2b,ff1d0f0c,ff160b09,fff19a53,fff19a53,");
...
void UiEditorAppStyler::labelTextChanged (Label* labelThatHasChanged)
{
    ...
    if (labelThatHasChanged == label_current_color)
    {
        ...
        colour_selector->setCurrentColour( Colour::fromString( String("0xFF")+label_current_color->getText() ) );
