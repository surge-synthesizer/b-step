...
private:
    uint32& get_background_color() override {
        return _color_theme->main_bg;
    }
    uint32& get_foreground_color() override {
        return _color_theme->step_area_bg;
    }
    uint32& get_border_color() override {
        return _color_theme->step_area_border;
    }
    uint32& get_element_border_color() override {
        return _color_theme->step_step_border;
    }
    uint32& get_slider_knob_color() override {
        return _color_theme->slider_knob_color;
    }
    uint32& get_slider_outline_color() override {
        return _color_theme->slider_outline;
    }

    uint32& get_state_off_1_color() override {
        return _color_theme->step_step_bg;
    }

    bool is_opaque() const override {
        return true;
    }
    bool is_wrapper_opaque() const override {
        return true;
    }
...
class StyleStepAreaMute : public StyleStepArea
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_1;
    }
    uint32& get_state_on_2_color() override {
        return _color_theme->elem_color_1;
    }
    uint32& get_state_off_2_color() override {
        return _color_theme->elem_color_4;
    }

    uint32& get_font_color() override {
        return _color_theme->elem_color_1;
    }
...
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_7;
    }
    uint32& get_font_color() override {
        return _color_theme->elem_color_7;
    }
...
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_8;
    }
    uint32& get_font_color() override {
        return _color_theme->elem_color_8;
    }
...
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_9;
    }
    uint32& get_font_color() override {
        return _color_theme->elem_color_9;
    }
...
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_10;
    }
    uint32& get_font_color() override {
        return _color_theme->elem_color_10;
    }
...
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_5;
    }
    uint32& get_font_color() override {
        return _color_theme->elem_color_5;
    }
    uint32& get_state_on_2_color() override {
        return _color_theme->elem_color_3;
    }
    uint32& get_state_off_2_color() override {
        return _color_theme->elem_color_4;
    }
...
private:
    ...
    uint32& get_foreground_color() override {
        return _color_theme->bar_area_bg;
    }
    uint32& get_border_color() override {
        return _color_theme->bar_area_border;
    }
    uint32& get_element_border_color() override {
        return _color_theme->bar_step_border;
    }
    uint32& get_slider_knob_color() override {
        return _color_theme->slider_knob_color;
    }
    ...
    uint32& get_state_off_1_color() override {
        return _color_theme->bar_step_bg;
    }
...
{
    uint32& get_state_on_1_color() override {
        return _color_theme->elem_color_6;
    }
    uint32& get_font_color() override {
        return _color_theme->elem_color_6;
    }
...
private:
    ...
    uint32& get_border_color() override {
        return _color_theme->main_border;
    }
    uint32& get_element_border_color() override {
        return _color_theme->main_step_border;
    }
    uint32& get_slider_knob_color() override {
        return _color_theme->slider_knob_color;
    }
    ...
    uint32& get_state_off_1_color() override {
        return _color_theme->main_step_bg;
    }
...
private:
    ...
    uint32& get_button_border_color() override {
...
public:
    StyleMenuArea( ColorTheme*const color_theme_ ) : _color_theme( color_theme_ ), button_border_color( 0xff444444 ), border_color(0xff5d5d5d) {}
};
...
public:
    StylePopupEditor( ColorTheme*const color_theme_ ) : _color_theme( color_theme_ ), bg_colour( 0xff161616 ), button_border_color( 0xff444444 )
    {
        int font_size = 21;
#ifdef JUCE_IOS
        font_size = 17;
