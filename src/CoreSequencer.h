...
class Sequencer
{
  ...
  public:
    ...
    void get_current_cc_messages(Array<MidiMessage *> &messages_, uint8 group_id_,
                                 bool only_0_and_32_);
    ...
    int8 get_string_offset(uint8 string_id_) { return string_offsets.getUnchecked(string_id_); }
