...
// ************************************************************************************************
// ************************************************************************************************
class ControllerStepMute :
    public MONO_UIButtonController
{
    ...
    PodParameterBase* get_parameter() const override {
        return &selected_step.get().is_mute;
    }
    ...
    void get_label_text_top( String& string_ ) const override
    {
        ...
        sum_octave_offset += _app_instance_store->pattern.master_string_octave( selected_step.barstring_id ).value();
...
public:
    ControllerStepMute ( AppInstanceStore* const app_instance_store_, uint8 barstring_id_, uint8 step_id_ ) :
