...
// ************************************************************************************************
// ************************************************************************************************
PodParameterBase::PodParameterBase( pod_type value_,
    ...
    : _value( value_ ),
      ...
      _param_ident( param_ident_ ),
      _param_unique_ident( param_unique_ident_ ),
      _help_url( help_url_ ),
      id( id_ ),
      _param_short_ident( param_short_ident_ ),
      _name( name_ ),
...
// ************************************************************************************************
// ************************************************************************************************
Parameters::Parameters( PodParameterBase* a_,
                        PodParameterBase* b_,
                        PodParameterBase* c_,
                        PodParameterBase* d_,
                        PodParameterBase* e_,
