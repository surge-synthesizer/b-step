...
class PodParameterBase
{
  ...
  public:
    ...
    inline const String &get_param_short_ident() const { return _param_short_ident; }
    ...
    inline const String &as_string() const { return _string_value; }
    ...
    inline uint8 value_unsigned() const { return _value - MIN; }
    inline uint8 remote_value_unsigned() const { return remote_state - MIN; }
  ...
  protected:
    PodParameterBase(pod_type value_, const unsigned int index_, const char *const param_ident_,
                     ...
                     const String &param_short_ident_, const String &name_, const pod_type min_,
                     const pod_type max_, const pod_type default_, int id_ = -1);
...
PodParameter<MIN_, DEFAULT_, MAX_, OWNER_INDEX_, IDENT_DEFINER_>::PodParameter()
    : PodParameterBase(DEFAULT_, INDEX, IDENT_DEFINER_::parameter_name(OWNER_INDEX_),
                       ...
                       IDENT_DEFINER_::parameter_name_short(OWNER_INDEX_),
                       String(IDENT_DEFINER_::parameter_name(OWNER_INDEX_)), MIN, MAX, DEFAULT)
{
}
...
template <pod_type MIN_, pod_type DEFAULT_, pod_type MAX_, unsigned int OWNER_INDEX_,
          class IDENT_DEFINER_>
PodParameter<MIN_, DEFAULT_, MAX_, OWNER_INDEX_, IDENT_DEFINER_>::PodParameter(
    const String &manual_id_)
    : PodParameterBase(DEFAULT_, INDEX, IDENT_DEFINER_::parameter_name(OWNER_INDEX_),
                       IDENT_DEFINER_::parameter_name_short(OWNER_INDEX_),
                       IDENT_DEFINER_::get_help_url(OWNER_INDEX_),
                       String(IDENT_DEFINER_::parameter_name_short(OWNER_INDEX_)) + manual_id_,
                       String(IDENT_DEFINER_::parameter_name(OWNER_INDEX_) + manual_id_), MIN, MAX,
                       DEFAULT)
{
}
...
PodParameter<MIN_, DEFAULT_, MAX_, OWNER_INDEX_, IDENT_DEFINER_>::PodParameter(int i)
    : PodParameterBase(
          DEFAULT_, INDEX, IDENT_DEFINER_::parameter_name(OWNER_INDEX_),
          IDENT_DEFINER_::parameter_name_short(OWNER_INDEX_),
          IDENT_DEFINER_::get_help_url(OWNER_INDEX_),
          String(IDENT_DEFINER_::parameter_name_short(OWNER_INDEX_)) + String("-") + String(i + 1),
          String(IDENT_DEFINER_::parameter_name(OWNER_INDEX_)) + (String("-") + String(i + 1)), MIN,
          MAX, DEFAULT, i)
{
    return;
}
