...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class UIHtmlView  : public UiEditor,
...
private:
    ...
    bool open_url( const URL& source_, bool and_download_complete_nav_content_ = false, bool show_content_ = true );
    bool open_question_mark_content( const URL& request_for_ = MANUAL_URL+"beginner/tools", bool force_redownload_ = false );
    ...
    int current_height;
    void add_text_part( const String&text_, int height_ /* 7 text, 1 title, 2 title (h2) */, int white_spaces_before_, bool show_content_, Colour col_ = Colour(0x00000000), bool make_selectable = false );
    void add_image( const String&url_, bool show_content_ );

    NavItem*last_added_item;
    int last_deppnes;
    void add_nav_link( const String&text_, const URL& target_, int deepness_, bool and_open_it = false );
