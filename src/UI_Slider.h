    ...
    public DragAndDropContainer
{
    ...
    void setTextBoxStyle( Slider::TextEntryBoxPosition box_pos_,
                          bool is_read_only,
                          int text_box_width,
                          int text_box_height );
...
public:
    ...
    void mouseDown (const MouseEvent& e_ ) {
        slider->mouseDown(e_);
    }
    void mouseUp (const MouseEvent& e_) {
        slider->mouseUp(e_);
    }
    void mouseMove (const MouseEvent& e_) {
        slider->mouseMove(e_);
    }
    void mouseEnter (const MouseEvent& e_) {
        slider->mouseEnter(e_);
    }
    void mouseExit (const MouseEvent& e_) {
        slider->mouseExit(e_);
    }
    void mouseDrag (const MouseEvent& e_) {
        slider->mouseDrag(e_);
    }
    void mouseDoubleClick (const MouseEvent& e_) {
        slider->mouseDoubleClick(e_);
    }
