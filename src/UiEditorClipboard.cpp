...
{
    toggle_copy_steps->setToggleState( _bar_copy_clipboard.is_copy_steps, NotificationType::dontSendNotification );
    toggle_copy_string_octave->setToggleState( _bar_copy_clipboard.is_copy_string_octave, NotificationType::dontSendNotification );
    toggle_copy_step_velocity->setToggleState( _bar_copy_clipboard.is_copy_step_velocity, NotificationType::dontSendNotification );
    toggle_copy_step_duration->setToggleState( _bar_copy_clipboard.is_copy_step_duration, NotificationType::dontSendNotification );
    toggle_copy_bar_groups->setToggleState( _bar_copy_clipboard.is_copy_bar_groups, NotificationType::dontSendNotification );
    toggle_copy_bar_solo->setToggleState( _bar_copy_clipboard.is_copy_bar_solo, NotificationType::dontSendNotification );
    toggle_copy_layer_1->setToggleState( _bar_copy_clipboard.is_copy_layer_1, NotificationType::dontSendNotification );
    toggle_copy_layer_2->setToggleState( _bar_copy_clipboard.is_copy_layer_2, NotificationType::dontSendNotification );
    toggle_copy_layer_3->setToggleState( _bar_copy_clipboard.is_copy_layer_3, NotificationType::dontSendNotification );
    toggle_copy_layer_4->setToggleState( _bar_copy_clipboard.is_copy_layer_4, NotificationType::dontSendNotification );
    toggle_copy_layer_5_6->setToggleState( _bar_copy_clipboard.is_copy_layer_5, NotificationType::dontSendNotification );
    toggle_copy_layer_7->setToggleState( _bar_copy_clipboard.is_copy_layer_7, NotificationType::dontSendNotification );
}
void UiEditorClipboard::timerCallback()
{
    reload_ui();
}
...
//==============================================================================
UiEditorClipboard::UiEditorClipboard (AppInstanceStore* const app_instance_store_, uint8 clipboard_id_)
...
{
    addAndMakeVisible (newComponent = new Label (String(),
            TRANS("Copy Steps")));
    ...
    newComponent->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent15 = new Label (String(),
            TRANS("Copy Step Duration")));
    ...
    newComponent15->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent14 = new Label (String(),
            TRANS("Copy Step Velocity\n")));
    ...
    newComponent14->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent13 = new Label (String(),
            TRANS("Copy Sequence#")));
    ...
    newComponent13->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent12 = new Label (String(),
            TRANS("Copy Bar Solo\n")));
    ...
    newComponent12->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent11 = new Label (String(),
            TRANS("Copy String Octave")));
    ...
    newComponent11->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent9 = new Label (String(),
            TRANS("Copy CC Layer Data (CC)")));
    ...
    newComponent9->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent8 = new Label (String(),
    ...
    newComponent8->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent7 = new Label (String(),
            TRANS("Copy Bar Layer Data (BAR)")));
    ...
    newComponent7->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent6 = new Label (String(),
            TRANS("Copy Step Layer Data (STEP)")));
    ...
    newComponent6->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent4 = new Label (String(),
            TRANS("Copy Sequence Layer Data (SEQ#)")));
    ...
    newComponent4->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent3 = new Label (String(),
            TRANS("Copy Main Layer Data (MAIN)")));
    ...
    newComponent3->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent10 = new Label (String(),
            TRANS("SELECT/UNSELECT ALL")));
    ...
    newComponent10->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent2 = new Label (String(),
    ...
    newComponent2->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (newComponent5 = new Label (String(),
            TRANS("Bar Snapshot Info :: 1")));
    ...
    newComponent5->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    label->setColour (Label::outlineColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    //[UserPreSize]
    newComponent5->setText( String("Bar Snapshot Info :: ").operator+=(_clipboard_id+1), dontSendNotification );
    reload_ui();
    //[/UserPreSize]
    ...
    label->setText( _bar_copy_clipboard.stored_bar_source_ident, NotificationType::dontSendNotification );
...
void UiEditorClipboard::resized()
{
    ...
    newComponent->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.2018f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    toggle_copy_steps->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.2105f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toolbar->setBounds (getWidth() - proportionOfWidth (0.1389f), 0, proportionOfWidth (0.1389f), proportionOfHeight (0.3509f));
    newComponent15->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.3772f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent14->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.3246f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent13->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.5000f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent12->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.4474f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent11->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.2544f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent9->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.8333f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent8->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.7807f), proportionOfWidth (0.7194f), proportionOfHeight (0.0526f));
    newComponent7->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.7281f), proportionOfWidth (0.7194f), proportionOfHeight (0.0526f));
    newComponent6->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.6228f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent4->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.6754f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent3->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.5702f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    newComponent10->setBounds (proportionOfWidth (0.1389f), proportionOfHeight (0.9035f), proportionOfWidth (0.7222f), proportionOfHeight (0.0526f));
    toggle_select_all->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.9123f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_layer_7->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.8421f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_layer_5_6->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.7895f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_layer_4->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.7368f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_layer_3->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.6842f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_layer_2->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.6316f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_layer_1->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.5790f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_bar_groups->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.5088f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_bar_solo->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.4561f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_step_duration->setBounds (proportionOfWidth (0.0583f), proportionOfHeight (0.3825f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_step_velocity->setBounds (proportionOfWidth (0.0583f), proportionOfHeight (0.3298f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    toggle_copy_string_octave->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.2632f), proportionOfWidth (0.7500f), proportionOfHeight (0.0421f));
    newComponent2->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.1228f), proportionOfWidth (0.7778f), proportionOfHeight (0.0702f));
    newComponent5->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.0175f), proportionOfWidth (0.7500f), proportionOfHeight (0.0702f));
    label->setBounds (proportionOfWidth (0.0694f), proportionOfHeight (0.0789f), proportionOfWidth (0.7361f), proportionOfHeight (0.0526f));
    button_info->setBounds (proportionOfWidth (0.8806f), proportionOfHeight (0.3597f), proportionOfWidth (0.0833f), proportionOfHeight (0.0526f));
...
void UiEditorClipboard::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == toggle_select_all)
    {
        ...
        toggle_copy_steps->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_layer_1->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_layer_2->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_layer_3->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_layer_4->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_layer_5_6->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_layer_7->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_string_octave->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_bar_solo->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_bar_groups->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_step_velocity->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
        toggle_copy_step_duration->setToggleState( buttonThatWasClicked->getToggleState(), NotificationType::sendNotification );
    ...
    else if (buttonThatWasClicked == button_info)
    {
        ...
        _app_instance_store->editor_config.manual_editor->try_open_url( MANUAL_URL+"experts/snapshots-and-the-clipboard" );
