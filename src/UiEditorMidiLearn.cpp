...
/*
    addAndMakeVisible (label_target4 = new UiLabel ("1:1 - ONE controller can assigned to only ONE target (last trained) (default)",_app_instance_store->style_popup_editor));

    addAndMakeVisible (label_target5 = new UiLabel ("1:n - ONE controller can assigned to N targets",_app_instance_store->style_popup_editor));

    addAndMakeVisible (label_target6 = new UiLabel ("n:1 - N controllers can assigned to ONE target",_app_instance_store->style_popup_editor));

    addAndMakeVisible (label_target7 = new UiLabel ("n:n - N controllers can assigned to N target",_app_instance_store->style_popup_editor));
*/
...
void UiEditorMidiLearn::load_assignments()
{
    ...
    Array< const MIDIInToControllerHandler* > handlers = map.get_registerd_handlers_for_learning_controller();
...
void UiEditorMidiLearn::refresh_ui()
{
    ...
    if
    (
        map.get_change_counter() != _last_change_counter
...
{
    addAndMakeVisible (label_target = new Label (String(),
            TRANS("MIDI LEARN")));
    ...
    label_target->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (label_target3 = new Label (String(),
            TRANS("Learn Mode")));
    ...
    label_target3->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    addAndMakeVisible (label_target8 = new Label (String(),
            TRANS("Assignments\n")));
    ...
    label_target8->setColour (Label::textColourId, Colour (GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR));
    ...
    button_remove_all_mappings->setImages (false, true, true,
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          TRANS("INFO: Select/click an element on the user interface then move a slider or push a button on your MIDI controller. Done.")));
...
void UiEditorMidiLearn::paint (Graphics& g)
{
    ...
    jassert (drawable1 != 0);
    if (drawable1 != 0)
        drawable1->drawWithin (g, Rectangle<float> (proportionOfWidth (0.8667f), proportionOfHeight (0.8000f), proportionOfWidth (0.1111f), proportionOfHeight (0.0960f)),
...
void UiEditorMidiLearn::resized()
{
    ...
    label_target->setBounds (proportionOfWidth (0.1111f), proportionOfHeight (0.0400f), proportionOfWidth (0.7778f), proportionOfHeight (0.1600f));
    delete_asignment->setBounds (proportionOfWidth (0.3333f), proportionOfHeight (0.5600f), proportionOfWidth (0.4444f), proportionOfHeight (0.1200f));
    cb_midi_learn_mode->setBounds (proportionOfWidth (0.3333f), proportionOfHeight (0.2400f), proportionOfWidth (0.4444f), proportionOfHeight (0.1200f));
    cb_midi_assigns->setBounds (proportionOfWidth (0.3333f), proportionOfHeight (0.4200f), proportionOfWidth (0.4444f), proportionOfHeight (0.1200f));
    toolbar->setBounds (getWidth() - proportionOfWidth (0.1389f), 0, proportionOfWidth (0.1389f), proportionOfHeight (0.8000f));
    label_target3->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.2400f), proportionOfWidth (0.2778f), proportionOfHeight (0.1200f));
    label_target8->setBounds (proportionOfWidth (0.0556f), proportionOfHeight (0.4200f), proportionOfWidth (0.2778f), proportionOfHeight (0.1200f));
