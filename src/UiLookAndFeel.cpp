...
UiLookAndFeel::UiLookAndFeel()
{
    ...
    static const uint32 standardColours[] =
    {
        ...
        Label::textColourId,                        GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
        ...
        PropertyComponent::labelTextColourId,       GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
        ...
        Slider::textBoxOutlineColourId,             GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
        ...
        Toolbar::labelTextColourId,                 GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
        ...
        0x1005003, /*MidiKeyboardComponent::mouseOverKeyOverlayColourId*/     GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
        0x1005004, /*MidiKeyboardComponent::keyDownOverlayColourId*/          GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
        ...
        FileChooserDialogBox::titleTextColourId,                GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR,
    };
...
{
    // isMouseOverButton
    Colour color_1 =  isButtonDown ? Colour(backgroundColour).darker (0.4f) : Colour(backgroundColour).brighter (0.25f);
    Colour color_2 =  isButtonDown ? Colour(backgroundColour).brighter (0.3f) : Colour (backgroundColour).darker (0.3f);
...
void UiLookAndFeel::drawButtonText (Graphics& g, TextButton& button, bool /*isMouseOverButton*/, bool /*isButtonDown*/)
{
    ...
    if( Colour ( button.findColour (TextButton::buttonColourId) ).getBrightness() < 0.3 && button.findColour (TextButton::textColourOffId).getBrightness() < 0.3 )
        g.setColour ( Colour(GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR) );
    else
        g.setColour ( Colour(button.findColour (TextButton::textColourOffId).withMultipliedAlpha ( button.isEnabled() ? 1.0f : 0.5f)) );
                                  ...
                                  int buttonX, int buttonY, int buttonW, int buttonH, ComboBox& box)
{
    ...
    {
        g.setColour (box.isEnabled() ? Colour(GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR) : Colour(GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR).darker());
        g.drawRect (0, 0, width, height);
    }
    ...
    drawGlassLozenge (g,
                      ...
                      box.isEnabled() ? Colour(GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR) : Colour(GLOBAL_VALUE_HOLDER::getInstance()->MASTER_COLOUR).darker(), outlineThickness, -1.0f,
                      true, true, true, true);
