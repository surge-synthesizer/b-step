...
//==============================================================================
mono_UiRefreshable::mono_UiRefreshable() { mono_UiRefresher::getInstance()->add(this); }
mono_UiRefreshable::~mono_UiRefreshable() { mono_UiRefresher::getInstance()->remove(this); }
